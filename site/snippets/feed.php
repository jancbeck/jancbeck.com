...
<rss version="2.0" xmlns:content="http://purl.org/rss/1.0/modules/content/" xmlns:wfw="http://wellformedweb.org/CommentAPI/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:atom="http://www.w3.org/2005/Atom">
  ...
  <channel>
    ...
    <item>
      ...
      <description><![CDATA[<?php echo $item->{$textfield}()->kirbytext() ?> <img src="//<?php echo $site->piwik_url() ?>/piwik.php?idsite=<?php echo $site->piwik_id() ?>&amp;rec=1&amp;url=<?php echo xml( $item->url()) ?>%2F%3Fpk_campaign%3Dfeed%26pk_kwd%3D<?php echo xml($item->id()) ?>&amp;action_name=<?php echo urlencode($item->title()) ?>&amp;urlref=<?php echo xml($link) ?>" style="border:0;width:0;height:0" width="0" height="0" alt="" />]]></description>
    </item>
    <?php endforeach ?>
