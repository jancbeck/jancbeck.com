...
<script type="text/javascript">
  ...
  (function() {
    _paq.push(['setTrackerUrl', '//analytics.jancbeck.com/'+'piwik.php']);
    _paq.push(['setSiteId', 1]);
    var d=document, g=d.createElement('script'), s=d.getElementsByTagName('script')[0]; g.type='text/javascript';
    g.defer=true; g.async=true; g.src='/piwik.js'; s.parentNode.insertBefore(g,s);
  })();

</script>
<noscript><p><img src="//analytics.jancbeck.com/piwik.php?idsite=1" style="border:0" alt="" /></p></noscript>
<!-- End Piwik Code -->
